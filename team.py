...
metadata = {
    ...
    "team_name": f"Mamba_out", 

    # Fill in the student IDs and emails of both team members here. There must
    # be exactly two members in the list. 
    "team_members": [
        {
            "name": "Frank (Feifan) Xia",
            "student_id": "1347999",
            "email": "feifanx@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Bill (Jiaxin) He",
            "student_id": "1455893",
            "email": "jiaxinh8@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
